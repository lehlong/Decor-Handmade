				...
				<div class="row">
					...
					<?php 
                                ...
                                <div id="product-imgs">
									...
									<?php 
									$num2=number_format($row['product_price']);
									echo '
                    ...
                    <div class="col-md-5">
						<div class="product-details">
							...
							<div>
								...
								<a class="review-link" href="#review-form">10 Đánh giá(s) | Thêm đánh giá của bạn</a>
							</div>
							<div>
								<h3 class="product-price">'.$num2.' VNĐ<del class="product-old-price"></del></h3>
							...
							<ul class="product-btns">
								<li><a href="#"><i class="fa fa-heart-o"></i> <th>Yêu thích sản phẩm </a></li>
												...
												<ul class="reviews">
													<li>
														<div class="review-heading">
															<h5 class="name">Hải Long</h5>
															<p class="date">25/12/2020, 10P.M</p>
														...
														<div class="review-body">
															<p>Sản phẩm dùng khá tốt!</p>
														</div>
													</li>
													<li>
														<div class="review-heading">
															<h5 class="name">Phương Trinh</h5>
															<p class="date">25/12/2020, 10P.M</p>
															<div class="review-rating">
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
														...
														<div class="review-body">
															<p>Mua về nhưng không biết dùng</p>
														</div>
													</li>
													<li>
														<div class="review-heading">
															<h5 class="name">Đức Huy</h5>
															<p class="date">25/12/2020, 10P.M</p>
															<div class="review-rating">
																<i class="fa fa-star"></i>
																<i class="fa fa-star"></i>
														...
														<div class="review-body">
															<p>Muốn mua nhưng không có tiền!</p>
														</div>
													</li>
												</ul>
