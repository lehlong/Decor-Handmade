			...
			<div id="header">
				...
				<div class="container">
					...
					<div class="row">
						...
						<img src="img/logo.webp" style="width:220px;height: 62px;">
								</a>
							</div>
						</div>
						<!-- /LOGO -->
						...
						<div class="col-md-6">
							<div class="header-search">
								<form>
									...
									<input class="input" id="search" type="text" placeholder="Nhập...">
						...
						<li><!-- <a href="#"><i class="fa fa-inr"></i> Địa chỉ</a> --></li>
						<li><?php
                             include "db.php";
                            if(isset($_SESSION["uid"])){
                                ...
                                echo '
                               <div class="dropdownn">
                                  <a href="#" class="dropdownn" data-toggle="modal" data-target="#myModal" ><i class="fa fa-user-o"></i> Xin chào '.$row["last_name"].'</a>
