		...
		if($count > 0){
			echo "
				<div class='alert alert-warning'>
						...
						<b>Sản phẩm đã thêm vào giỏ hàng</b>
				</div>
			";//not in video
		} else {
				...
				echo '
                    ...
                    <div class="product-widget">
												...
												<div class="product-body">
													...
													<h4 class="product-price"><span class="qty">'.$n.'</span> VNĐ'.$product_price.'</h4>
												</div>
				...
				while ($row=mysqli_fetch_array($query)) {
					...
					echo 
						...
						<tr>
							...
							<td data-th="Subtotal" class="text-center"><input type="text" class="form-control total" value="'.$product_price.' VNĐ" readonly="readonly"></td>
				...
				if (!isset($_SESSION["uid"])) {
					...
					echo '
						...
						<form action="checkout.php" method="post">
							...
							<input type="hidden" name="business" value="hlonn.it@gmail.com">
							...
							echo   
								'<input type="hidden" name="return" value="http://localhost/epushop/payment_success.php"/>
					                <input type="hidden" name="notify_url" value="http://localhost/epushop/payment_success.php">
									<input type="hidden" name="cancel_return" value="http://localhost/epushop/cancel.php"/>
