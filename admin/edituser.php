...
$result=mysqli_query($con,"select user_id,first_name,last_name, email, password, address1, address2 from user_info where user_id='$user_id'")or die ("query 1 incorrect.......");

list($user_id,$first_name,$last_name,$email,$user_password,$address1,$address2)=mysqli_fetch_array($result);
...
mysqli_query($con,"update user_info set first_name='$first_name', last_name='$last_name', email='$email', password='$user_password',address1='$address1',address2='$address2' where user_id='$user_id'")or die("Query 2 is inncorrect..........");
