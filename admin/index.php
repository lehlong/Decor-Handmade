        ...
        <div class="container-fluid">
         <div class="panel-body">
                ...
                <div class="table-responsive ps">
                  <table class="table table-hover tablesorter " id="">
                    <thead class=" text-primary">
                        <tr><th>ID</th><th>Tên họ</th><th>Tên</th><th>Email</th><th>Mật khẩu</th><th>Liên lạc</th><th>Địa chỉ</th><th>Thành phố</th>
                    </tr></thead>
                    <tbody>
                      <?php 
            ...
            <div class="card ">
              ...
              <div class="card-body">
                <div class="table-responsive ps">
                  <table class="table table-hover tablesorter " id="">
                    <thead class=" text-primary">
                        <tr><th>ID</th><th>Thể loại</th><th>Số lượng</th>
                    </tr></thead>
                    <tbody>
                      <?php 
          ...
          <div class="col-md-6">
            <div class="card ">
              <div class="card-header card-header-primary">
                <h4 class="card-title">Tên thương hiệu</h4>
              </div>
              <div class="card-body">
                <div class="table-responsive ps">
                  <table class="table table-hover tablesorter " id="">
