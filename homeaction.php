...
if(isset($_POST["categoryhome"])){
	...
	echo "
				...
				<div id='responsive-nav'>
                    ...
                    <li><a href='https://vnexpress.net/so-hoa'>Tin tức</a></li>
	";
                       ...
                       <div class='product-widget'>
                                <a href='product.php?p=$pro_id'> 
									...
									<div class='product-body'>
										...
										<h4 class='product-price'>$num VNĐ<del class='product-old-price'></del></h4>
									</div></a>
								</div>
...
if(isset($_POST["gethomeProduct"])){
	...
	$product_query = "SELECT * FROM products,categories WHERE product_cat=cat_id AND product_id BETWEEN 0 AND 200";
	$run_query = mysqli_query($con,$product_query);
	if(mysqli_num_rows($run_query) > 0){
